  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyBwxB1b9KLeX6d6MixtZI37I0DPxyV-csc",
        appId: "1:476551243988:web:7d875ff1fe6a5b183c3341",
        messagingSenderId: "476551243988",
        projectId: "instagram-clone-flutter-1a60d",
        storageBucket: 'instagram-clone-flutter-1a60d.appspot.com'
      ),
    );
  } else {
    await Firebase.initializeApp();
